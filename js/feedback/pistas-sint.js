...
export const FEEDBACK_SINTAXIS = [
  ...
  // ── Pares nuevos añadidos mayo 2026 ──────────────────────────────────────
  {real:"CD",marcada:"CI",fijo:"Sé que has visto a una persona y has pensado en el CI. Pero, ¿qué ocurre si cambias a esa persona por un objeto femenino? ¿Dices 'le' o 'la'?",pista:"Aplica la prueba del género: sustituye el sintagma por un nombre femenino. Si el pronombre resultante es LA, has encontrado un Sintagma Nominal en función de CD."},
  {real:"C.Rég.",marcada:"CC",fijo:"Has marcado un 'decorado' (CC). Pero intenta eliminar ese sintagma. ¿El verbo se queda 'cojo' o cambia de significado por completo?",pista:"Este no es un detalle opcional. Es un Sintagma Preposicional exigido 'por contrato' por el verbo. Prueba a sustituir el término por 'ESO': si la preposición se queda pegada al verbo, es un Complemento de Régimen."},
  {real:"CD",marcada:"Atr.",fijo:"Has visto que se sustituye por 'LO', pero mira el verbo. ¿Es un verbo de estado (ser, estar, parecer) o un verbo de acción con significado pleno?",pista:"Aunque ambos usen 'LO', el CD recibe la acción y el Atributo define al sujeto. Si el verbo es transitivo (como querer o comprar), ese 'LO' representa a un Sintagma Nominal en función de CD."},
  {real:"Vocativo",marcada:"Sujeto",fijo:"Fíjate en esa coma. ¿Esa palabra está realizando la acción del verbo o simplemente estás llamando la atención de alguien para que te escuche?",pista:"El Vocativo es una función extraoracional. No concuerda con el verbo: puedes decir 'Juan, ven' donde Juan es 3.ª persona y ven es 2.ª. El Sujeto, en cambio, siempre concuerda con el verbo."},
  {real:"Atr.",marcada:"CPvo",fijo:"¿El verbo realmente indica una acción o describe un cambio de estado del sujeto (como ponerse o volverse)?",pista:"Con verbos semicopulativos (ponerse, volverse, quedarse…), el adjetivo no es un complemento extra sino la parte esencial del mensaje. Analízalo como el Atributo de una estructura de cambio de estado."},
  {real:"Dativo",marcada:"CI",fijo:"Intenta eliminar ese pronombre ('me', 'te', 'se'). ¿La frase sigue teniendo sentido y mantiene los mismos protagonistas?",pista:"Si al quitar el pronombre la oración es gramatical y solo pierde un matiz afectivo o de énfasis (ej. 'Se comió la tarta' → 'Comió la tarta'), estás ante un Dativo (ético o aspectual), no un CI argumental."},
];
