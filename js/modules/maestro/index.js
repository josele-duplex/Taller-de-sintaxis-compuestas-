/* maestro/index.js — Modo morfologia avanzada (Maestro) + Morph Challenge
   ...
   Ago-2026 (A8 de la auditoria): las cascadas de rasgos salieron de aqui
   a js/data/cascadas-morfologia.js, y el banco de respaldo (MAESTRO_DEMO/
   MAESTRO_TEXTS) a js/data/maestro-demo.js. Este archivo se quedo con el
   motor de interfaz; se siguen reexportando MORPH_CASCADES /
   MORPH_CASCADES_ESO34 / getCascadeForNivel / MAESTRO_DEMO / MAESTRO_TEXTS /
   normalizePerifrasTokenAtrs / buildMaestroText para no romper a quien los
   importe desde el modulo.
...
// nivel, dispatch por atrs.funcion y fallback.
import {
  MORPH_CASCADES, MORPH_CASCADES_ESO34,
  getFuncionToken_, getEffectiveCorrectAtrs_, getCascadeForNivel
} from '../../data/cascadas-morfologia.js';
// El banco de respaldo (texto de demostracion sin API) vive en
// js/data/maestro-demo.js desde ago-2026 (hallazgo A8 de la auditoria).
import {
  MAESTRO_DEMO, MAESTRO_TEXTS, normalizePerifrasTokenAtrs, buildMaestroText
} from '../../data/maestro-demo.js';
...
// ── MORPHOLOGY CASCADE DEFINITIONS ──────────────────────────────────
// Las cascadas (qué rasgos se preguntan de cada categoría y en qué orden,
// para cada uno de los tres niveles) vivían aquí y ahora son datos:
// js/data/cascadas-morfologia.js. Se importan arriba. Este módulo solo
// las PINTA — si hay que corregir un rasgo o añadir una opción, se toca
// el archivo de datos, no este. (Hallazgo A8, auditoría ago-2026.)
