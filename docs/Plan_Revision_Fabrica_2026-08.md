...
- **Bases supletivas y haplología** (*lactosa*, *fidelidad*, *calamidad*): materia preciosa… para Bachillerato avanzado o PAU de matrícula. El curso que viene, si el nivel Maestro se queda corto, es un mini-lote propio («las bases cultas») — no ahora.
